    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background grid-pattern">
      ...
      >
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-black tracking-tighter">Engineering Lab</h1>
          <p className="text-muted-foreground font-medium leading-relaxed">
            We are calibrating the virtual lab environment for VLSI and Embedded testing. Access will be granted shortly.
          </p>
        </div>
        <div className="flex items-center gap-2 justify-center text-primary font-bold animate-pulse">
          <Construction className="h-4 w-4" /> System Calibration in Progress...
        </div>
