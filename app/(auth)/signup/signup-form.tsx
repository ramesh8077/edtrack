...
export function SignupForm() {
  ...
  async function onSubmit(data: SignupInput) {
    ...
    try {
      ...
      if (result.error) {
        ...
        if (result.details) {
          // You could optionally set form errors here based on details
          console.error(result.details);
        }
      } else {
        toast.success("Account created! Please check your email to verify.");
        // We log them in automatically and push to dashboard
  ...
  return (
    <div className="grid gap-6">
      ...
      <form action={() => signIn("google", { redirectTo: "/dashboard" })}>
