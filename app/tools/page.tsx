...
import { Zap, Cpu, ArrowLeft, Settings } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background grid-pattern">
      ...
      >
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-black tracking-tighter">AI Engineering Tools</h1>
          <p className="text-muted-foreground font-medium leading-relaxed">
            From PCB auto-routers to Verilog synthesizers, our AI tools are being fine-tuned for production use.
          </p>
        </div>
        <div className="flex items-center gap-2 justify-center text-primary font-bold">
          <Settings className="h-4 w-4 animate-spin-slow" /> Neural Engine Optimizing...
        </div>
