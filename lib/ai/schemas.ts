      ...
      z.object({
        ...
        lessons: z.array(
          z.object({
            ...
            contentMd: z
              .string()
              .describe(
                "Comprehensive raw markdown content of the lesson. Includes thorough explanations, analogies, and code snippets where relevant. Should be at least 3-4 paragraphs long.",
              ),
        ...
        quiz: z.object({
          ...
          questions: z
            .array(
              z.object({
                ...
                options: z
                  ...
                  .optional()
                  .describe(
                    "Provide exactly 4 string options if type is MCQ or MSQ. Omit if OPEN.",
                  ),
                correctAnswer: z
                  .union([z.string(), z.array(z.string())])
                  .describe(
                    "A single string identical to one of the options for MCQ. An array of option strings for MSQ. Or a highly detailed string for OPEN.",
                  ),
            ...
            .length(5)
            .describe("Generate exactly 5 questions per quiz. Make them varied in difficulty."),
        }),
      }),
    )
    .min(4)
    .max(8)
    .describe("Generate between 4 and 8 modules forming a comprehensive start-to-finish syllabus."),
});
